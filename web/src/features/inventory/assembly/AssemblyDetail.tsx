...
export function AssemblyDetail({ orgId, assemblyId, onClose }: AssemblyDetailProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#fff' }}>
      ...
      <div
        style={{ flex: 1, overflow: 'auto', padding: 24, display: isPdfView ? 'none' : 'block' }}
      >
        {activeTab === 'History' && (
          <AssemblyActivityTimeline orgId={orgId} assemblyId={assemblyId} />
        )}
        {activeTab === 'Comment' && <AssemblyComments orgId={orgId} assemblyId={assemblyId} />}
        {activeTab === 'Overview' && (
          <>
            <div
              style={{
            ...
            <p style={{ fontSize: 14, color: '#64748b', margin: '0 0 32px' }}>
              Assembly#{' '}
              <span style={{ fontWeight: 600, color: '#1e293b' }}>{assembly.assemblyNumber}</span>
            </p>
            ...
            <div style={{ display: 'flex', gap: 64, marginBottom: 48 }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', marginBottom: 16 }}>
                  ...
                  <div style={{ color: '#0062ff', fontSize: 14 }}>
                    {assembly.compositeItem?.name || '-'}
                  </div>
                </div>
                <div style={{ display: 'flex', marginBottom: 16 }}>
                  <div style={{ width: 160, color: '#64748b', fontSize: 13 }}>
                    Composite Item SKU
                  </div>
                  <div style={{ color: '#1e293b', fontSize: 14 }}>
                    {assembly.compositeItem?.sku || '-'}
                  </div>
                </div>
                <div style={{ display: 'flex', marginBottom: 16 }}>
              ...
              <div style={{ width: 320 }}>
                <div
                  style={{ background: '#f8fafc', padding: 24, borderRadius: 8, marginBottom: 24 }}
                >
                  <div
                    style={{
                      color: '#1e293b',
                ...
                <div>
                  <div style={{ color: '#1e293b', fontSize: 14, marginBottom: 4 }}>
                    Quantity Assembled
                  </div>
