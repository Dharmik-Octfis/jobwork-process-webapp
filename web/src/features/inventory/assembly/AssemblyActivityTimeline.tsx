...
interface AssemblyActivityTimelineProps {
  orgId: string;
  assemblyId: string;
}

export function AssemblyActivityTimeline({ orgId, assemblyId }: AssemblyActivityTimelineProps) {
  const { data: activities = [], isLoading } = useQuery({
    queryKey: ['assembly-activities', orgId, assemblyId],
    queryFn: () => assembliesApi.getActivities(orgId, assemblyId),
