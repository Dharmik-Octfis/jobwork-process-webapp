...
export function EditCompositeItemPage() {
  ...
  const [multiSelectServiceTargetIndex, setMultiSelectServiceTargetIndex] = useState<number | null>(null);
    ...
    if (fetchedComponents.length > 0) {
      ...
      fetchedComponents.forEach((comp: CompositeComponent) => {
        const row: ComponentRow = {
          componentItemId: comp.component_item_id || (comp as unknown as { componentItemId?: string }).componentItemId || '',
          qtyPerUnit: comp.qty_per_unit || (comp as unknown as { qtyPerUnit?: number }).qtyPerUnit || 1,
