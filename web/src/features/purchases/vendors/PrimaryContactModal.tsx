...
export interface PrimaryContactModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function PrimaryContactModal({ isOpen, onClose, onSubmit, initialData, title = 'Add Contact' }: PrimaryContactModalProps) {
  const {
    register,
    control,
    handleSubmit,
