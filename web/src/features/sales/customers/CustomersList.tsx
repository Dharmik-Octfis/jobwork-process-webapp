  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', overflow: 'hidden', background: '#f8fafc' }}>
        <div style={{ flex: selectedCustomerId ? '0 0 320px' : 1, borderRight: selectedCustomerId ? '1px solid #eef0f3' : 'none', display: 'flex', flexDirection: 'column', background: '#fff' }}>
          ...
          >
            ...
            <p style={{ color: '#64748b', maxWidth: 400, margin: '0 0 24px 0', lineHeight: 1.5 }}>
              You haven't added any customers yet. Create your first customer to start creating purchase
              orders and bills.
            </p>
            <button
              onClick={() => navigate(`/organizations/${orgId}/sales/customers/new`)}
                ...
                {customers.map((customer) => (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: '1px solid #eef0f3',
                      cursor: 'pointer',
                      background: selectedCustomerId === customer.id ? '#f1f5f9' : 'transparent',
                      transition: 'background 0.1s',
                    }}
                    onMouseEnter={(e) => {
                      if (selectedCustomerId !== customer.id) e.currentTarget.style.background = '#f8fafc';
                    }}
                    onMouseLeave={(e) => {
                      if (selectedCustomerId !== customer.id) e.currentTarget.style.background = 'transparent';
                    }}
                  >
