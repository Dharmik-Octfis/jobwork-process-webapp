...
export function AddOpeningStockModal({
  ...
  useEffect(() => {
    ...
    setLocationRows([createEmptyLocation()]);
  }, [initialRows, isOpen]);
                  ...
                  <tr key={batch.id}>
                    {batchIndex === 0 && (
                      <>
                        <td
                          ...
                          style={{ padding: '8px', verticalAlign: 'top', borderRight: '1px solid #eef0f3' }}
                        >
                          <Select
                    ...
                    <td style={{ padding: '8px' }}>
                      <input
                        ...
                        onChange={(e) => updateBatch(loc.id, batch.id, 'batchReference', e.target.value)}
                        style={inputStyle}
                        onFocus={(e) => (e.target.style.borderColor = '#0062ff')}
                        onBlur={(e) => (e.target.style.borderColor = '#cbd5e1')}
                      />
                    ...
                    <td style={{ padding: '8px' }}>
                      <input
                        ...
                        onChange={(e) => updateBatch(loc.id, batch.id, 'manufacturerBatch', e.target.value)}
                        style={inputStyle}
                        onFocus={(e) => (e.target.style.borderColor = '#0062ff')}
                        onBlur={(e) => (e.target.style.borderColor = '#cbd5e1')}
                      />
                    ...
                    <td style={{ padding: '8px' }}>
                      <input
                        ...
                        onChange={(e) => updateBatch(loc.id, batch.id, 'manufacturedDate', e.target.value)}
                        style={inputStyle}
                        onFocus={(e) => (e.target.style.borderColor = '#0062ff')}
                        onBlur={(e) => (e.target.style.borderColor = '#cbd5e1')}
                      />
                    ...
                    <td style={{ padding: '8px' }}>
                      <input
                        ...
                        onChange={(e) => updateBatch(loc.id, batch.id, 'sellingPrice', e.target.value)}
                        style={rightAlignStyle}
                        onFocus={(e) => (e.target.style.borderColor = '#0062ff')}
                        onBlur={(e) => (e.target.style.borderColor = '#cbd5e1')}
                      />
                    ...
                    <td style={{ padding: '8px', textAlign: 'center', borderRight: '1px solid #eef0f3' }}>
                      <button
                        type="button"
                    ...
                    {batchIndex === 0 && (
                      <td rowSpan={loc.batches.length + 1} style={{ padding: '8px', textAlign: 'center', verticalAlign: 'top' }}>
                        <button
                          type="button"
                ...
                <tr>
                  <td colSpan={8} style={{ padding: '8px', borderRight: '1px solid #eef0f3' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ display: 'flex', gap: '16px', fontSize: '12px', color: '#f59e0b' }}>
                        <span>Quantity To Be Added: {loc.openingStock || 0}</span>
                        <span>
                          Added Qty to Location :{' '}
                          {loc.batches.reduce((acc, b) => acc + (parseFloat(String(b.quantityIn)) || 0), 0)}
                        </span>
                      </div>
                    </div>
                  </td>
