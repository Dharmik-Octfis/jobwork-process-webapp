...
export const LIST_COLUMNS: Record<ListEntityType, readonly ColumnDef[]> = {
  ...
  purchase_order: [
    ...
    { key: 'poNumber', label: 'Purchase Order#', locked: true },
    { key: 'referenceNumber', label: 'Reference#', defaultVisible: true },
    { key: 'vendor', label: 'Vendor Name', defaultVisible: true },
    { key: 'status', label: 'Status', defaultVisible: true },
    { key: 'billedStatus', label: 'Billed Status', defaultVisible: true },
