...
export const LIST_COLUMNS: Record<EntityType, readonly ColumnDef[]> = {
  vendor: [
    { key: 'displayName', label: 'Name', locked: true },
    { key: 'companyName', label: 'Company Name', defaultVisible: true },
    { key: 'vendorNumber', label: 'Vendor Number', defaultVisible: true },
  ...
  customer: [
    { key: 'displayName', label: 'Name', locked: true },
    { key: 'companyName', label: 'Company Name', defaultVisible: true },
    { key: 'customerNumber', label: 'Customer Number', defaultVisible: true },
    { key: 'workPhone', label: 'Work Phone', defaultVisible: true },
    { key: 'emailAddress', label: 'Email', defaultVisible: true },
    { key: 'mobilePhone', label: 'Mobile Phone' },
    { key: 'currency', label: 'Currency' },
